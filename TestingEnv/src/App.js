        ...
        <div >
          ...
          <nav style={{ padding: '0px 30px 0px 30px' }}>
            <div class="nav-wrapper" >
              <a href="/buyTickets" class="brand-logo left">Micro Pets</a>
              <ul class="right hide-on-med-and-down 10" >
                <div>
                  <li> <Link to="/createFestival">Add NFT type</Link> </li>
                  <li> <Link to="/buyTickets">Buy NFT</Link> </li>
                  <li> <Link to="/market">Market</Link> </li>
                  <li> <Link to="/tickets">My NFTs</Link> </li>
                  <li >
                  </li>
                </div>
